...
{ // Part 1
    ...
    console.log(`[Part 1] Found ${validPassports} of ${passports.length} valid passports`)
}
...
{ // Part 2
    ...
    for (const passport of passports) {
        ...
        for (const field of mandatoryFields) {
            ...
            valid = validations[field](passport[field])
            if (!valid) break
        }
        if (!valid) continue
    ...
    console.log(`[Part 2] Found ${validPassports} of ${passports.length} valid passports`)
}